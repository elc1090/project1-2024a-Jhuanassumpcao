function validarFormulario() {
    ...
    console.log(nomeAlunoValue, nomeProfessorValue, dataValue, horaValue, semestreValue, conteudoApresentacao, dominio, poderSintese, estrutura, relOriQual, conhecimento, adequacao, dataFim, selected)
